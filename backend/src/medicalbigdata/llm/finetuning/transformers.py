...
def finetune_tf(model_name, dataset, load_in_4bit=False, n_splits=5, n_epochs=5, eval_strat="BEST_AFTER_5",
                wandb_tags=None):
    ...
    if wandb_tags:
        wandb.init(
            ...
            tags=["fine-tuned", "LoRA", "transformers"] + wandb_tags
        )
        ...
        class CustomEarlyStoppingCallback(EarlyStoppingCallback):
            ...
            def check_metric_value(self, args, state, control, metric_value):
                if len(state.log_history) % 2 == 0:  # every second call is the one for the val split!
                    ...
                    print("\nEARLY-STOP AUC:", metric_value, "BEST AUC:", self.best_metric, "COUNTER:",
